...
def createScene(rootNode):
    ...
    finger.addObject('MeshOBJLoader', name='loader', filename='../../data/Softnet/Extension/a12/model.obj', rotation=[0, 180, 270], translation=[150,-170,25]) # load the object in
    ...
    finger.addObject('Monitor', name="fingerMonitor", 
                 template="Vec3d",
                 listening=True, 
                 indices="10",  # Track vertex index 10 (Change this to the point you want to track)
    ...
    boxROI = finger.addObject('BoxROI', name='boxROI', box=[152, -5, 0, 160, 11, 30], drawBoxes=True)
    ...
    # stiff layer
    boxROISubTopo = finger.addObject('BoxROI', name='boxROISubTopo', box=[150, -165, 8, 180, -10, 23],
    ...
    modelVisu.addObject('MeshOBJLoader', name='loader', filename='../../data/Softnet/Extension/a12/model.obj', rotation=[0, 180, 270], translation=[150,-170,25])
    ...
    cavityBox = cavity.addObject('BoxROI', name='cavityBox', box=[155, -160, 8, 165, -15, 23], drawBoxes=True, strict=True)
