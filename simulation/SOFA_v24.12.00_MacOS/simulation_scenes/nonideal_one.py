...
def createScene(rootNode):
    ...
    finger.addObject('MeshOBJLoader', name='loader', filename='../../data/Softnet/Bending/a16/model.obj', rotation=[90, 0, 270], translation=[170,9,10]) # load the object in
    ...
    boxROI = finger.addObject('BoxROI', name='boxROI', box=[152, 5, 0, 156, 10, 30], drawBoxes=True)
    ...
    # stiff layer
    boxROISubTopo = finger.addObject('BoxROI', name='boxROISubTopo', box=[150, -90, 8, 200, -37, 23],
    ...
    modelVisu.addObject('MeshOBJLoader', name='loader', filename='../../data/Softnet/Bending/a16/model.obj', rotation=[90, 0, 270], translation=[170,9,10])
    ...
    cavityBox = cavity.addObject('BoxROI', name='cavityBox', box=[155, -85, 8, 165, -5, 23], drawBoxes=True, strict=True)
