...
x_pos, y_pos, z_pos = positions[:, 1] + 120, positions[:, 2] + 9, positions[:, 3] + 10
x_posB, y_posB, z_posB = positionsB[:, 1] + 120 , positionsB[:, 2] + 9, positionsB[:, 3] + 10
...
theta_xz = np.arccos(dot_products / magnitudes) * (180 / np.pi) - 20
