...
class SphereCollisionModel(Object):
    """Collision model which represents a set of Spheres."""

    def __init__(self, template: Optional[str] = None, name: str,printLog: bool,tags: object,bbox: object,componentState: object,listening: bool,active: bool,moving: bool,simulated: bool,selfCollision: bool,proximity: float,contactStiffness: float,contactFriction: float,contactRestitution: float,contactResponse: str,color: object,group: TypeHints.SofaArray,numberOfContacts: int,listRadius: TypeHints.SofaArray,radius: float,showImpostors: bool):
        """Collision model which represents a set of Spheres.
...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.
           ...
           group (TypeHints.SofaArray):   IDs of the groups containing this model. No collision can occur between collision models included in a common group (e.g. allowing the same object to have multiple collision models)
           listRadius (TypeHints.SofaArray):   Radius of each sphere
           ...
           radius (float):   Default radius
           selfCollision (bool):   flag indication if the object can self collide
           showImpostors (bool):   Draw spheres as impostors instead of "real" spheres
    ...
    group: Data[TypeHints.SofaArray] 
    ...
    listRadius: Data[TypeHints.SofaArray] 
    'Radius of each sphere'

    radius: Data[float] 
    'Default radius'

    showImpostors: Data[bool] 
