...
class TubularMapping(Object):
    ...
    def __init__(self, template: Optional[str] = None, name: str,printLog: bool,tags: object,bbox: object,componentState: object,listening: bool,mapForces: bool,mapConstraints: bool,mapMasses: bool,mapMatrices: bool,applyRestPosition: bool,nbPointsOnEachCircle: int,radius: float,peak: int):
        """Create a Tube around rigid points.
