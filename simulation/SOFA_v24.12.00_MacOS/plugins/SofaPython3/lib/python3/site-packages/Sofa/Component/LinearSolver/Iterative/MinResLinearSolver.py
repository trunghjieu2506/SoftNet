...
class MinResLinearSolver(Object):
    ...
    def __init__(self, template: Optional[str] = None, name: str,printLog: bool,tags: object,bbox: object,componentState: object,listening: bool,parallelInverseProduct: bool,iterations: int,tolerance: float,graph: TypeHints.SofaArray):
        """Linear system solver using the MINRES iterative algorithm.
        
        Args:
           bbox (object):   this object bounding box
           componentState (object):   The state of the component among (Dirty, Valid, Undefined, Loading, Invalid).
           graph (TypeHints.SofaArray):   Graph of residuals at each iteration
    ...
    graph: Data[TypeHints.SofaArray] 
