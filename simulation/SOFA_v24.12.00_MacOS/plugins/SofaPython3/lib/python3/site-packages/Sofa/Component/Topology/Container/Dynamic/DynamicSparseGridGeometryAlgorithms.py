...
class DynamicSparseGridGeometryAlgorithms(Object):
    """Dynamic sparse grid geometry algorithms."""

    def __init__(self, template: Optional[str] = None, name: str,printLog: bool,tags: object,bbox: object,componentState: object,listening: bool,showIndicesScale: float,showPointIndices: bool,tagMechanics: str,showEdgeIndices: bool,drawEdges: bool,drawColorEdges: object,showQuadIndices: bool,drawQuads: bool,drawColorQuads: object,showHexaIndices: bool,drawHexahedra: bool,drawScaleHexahedra: float,drawColorHexahedra: object):
        """Dynamic sparse grid geometry algorithms.
