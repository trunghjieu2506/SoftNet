...
class WarpPreconditioner(Object):
    """Linear system solver wrapping another (precomputed) linear solver by a per-node rotation matrix."""

    def __init__(self, template: Optional[str] = None, name: str,printLog: bool,tags: object,bbox: object,componentState: object,listening: bool,parallelInverseProduct: bool,useRotationFinder: int,update_step: int):
        """Linear system solver wrapping another (precomputed) linear solver by a per-node rotation matrix.
        ...
        Args:
           ...
           update_step (int):   Number of steps before the next refresh of the system matrix in the main solver
           useRotationFinder (int):   Which rotation Finder to use
