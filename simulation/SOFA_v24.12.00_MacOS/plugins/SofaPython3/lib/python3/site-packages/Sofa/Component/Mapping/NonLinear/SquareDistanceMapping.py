...
class SquareDistanceMapping(Object):
    """Mapping point positions to square distances."""

    def __init__(self, template: Optional[str] = None, name: str,printLog: bool,tags: object,bbox: object,componentState: object,listening: bool,mapForces: bool,mapConstraints: bool,mapMasses: bool,mapMatrices: bool,applyRestPosition: bool,geometricStiffness: object,showObjectScale: float,showColor: object):
        """Mapping point positions to square distances.
