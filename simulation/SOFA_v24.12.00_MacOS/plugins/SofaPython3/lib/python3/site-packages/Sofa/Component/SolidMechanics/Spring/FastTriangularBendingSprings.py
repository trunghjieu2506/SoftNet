...
class FastTriangularBendingSprings(Object):
    ...
    def __init__(self, template: Optional[str] = None, name: str,printLog: bool,tags: object,bbox: object,componentState: object,listening: bool,rayleighStiffness: float,bendingStiffness: float,minDistValidity: float,edgeInfo: TypeHints.SofaArray):
        """Springs added to a triangular mesh to prevent bending.
