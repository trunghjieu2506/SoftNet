...
class PrecomputedLinearSolver(Object):
    """Linear system solver based on a precomputed inverse matrix"""

    def __init__(self, template: Optional[str] = None, name: str,printLog: bool,tags: object,bbox: object,componentState: object,listening: bool,parallelInverseProduct: bool,jmjt_twostep: bool,use_file: bool):
        """Linear system solver based on a precomputed inverse matrix
        
        Args:
           bbox (object):   this object bounding box
           componentState (object):   The state of the component among (Dirty, Valid, Undefined, Loading, Invalid).
           jmjt_twostep (bool):   Use two step algorithm to compute JMinvJt
           ...
           use_file (bool):   Dump system matrix in a file
