...
"""
Component MatrixLinearSystem

.. autofunction:: MatrixLinearSystem
...
Linear system."""
    ...
    def __init__(self, template: Optional[str] = None, name: str,printLog: bool,tags: object,bbox: object,componentState: object,listening: bool,matrixSize: TypeHints.SofaArray,assembleStiffness: bool,assembleMass: bool,assembleDamping: bool,assembleGeometricStiffness: bool,applyProjectiveConstraints: bool,applyMappedComponents: bool,checkIndices: bool,parallelAssemblyIndependentMatrices: bool):
        """Linear system dedicated to a Band Tri Diagonal matrix.
Linear system.
        ...
        Args:
           ...
           matrixSize (TypeHints.SofaArray):   Size of the global matrix
    ...
    matrixSize: Data[TypeHints.SofaArray] 
