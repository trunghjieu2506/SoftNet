...
class LineCollisionModel(Object):
    ...
    def __init__(self, template: Optional[str] = None, name: str,printLog: bool,tags: object,bbox: object,componentState: object,listening: bool,active: bool,moving: bool,simulated: bool,selfCollision: bool,proximity: float,contactStiffness: float,contactFriction: float,contactRestitution: float,contactResponse: str,color: object,group: TypeHints.SofaArray,numberOfContacts: int,bothSide: bool,displayFreePosition: bool):
        ...
        Args:
           ...
           bothSide (bool):   activate collision on both side of the line model (when surface normals are defined on these lines)
...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.
           ...
           displayFreePosition (bool):   Display Collision Model Points free position(in green)
