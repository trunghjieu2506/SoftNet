...
class TriangleSetTopologyContainer(Object):
    """Topology container dedicated to a triangular topology."""

    def __init__(self, template: Optional[str] = None, name: str,printLog: bool,tags: object,bbox: object,componentState: object,listening: bool,filename: str,position: TypeHints.SofaArray,checkTopology: bool,nbPoints: int,edges: TypeHints.SofaArray,checkConnexity: bool,triangles: TypeHints.SofaArray):
        """Topology container dedicated to a triangular topology.
